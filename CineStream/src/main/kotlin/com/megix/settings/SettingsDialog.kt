...
internal object SettingsDialog {
    ...
    private fun buildCreditsCard(context: Context): View {
        ...
        val contributors = listOf(
            Triple("Saurabh Kaperwan (megix)", "Creator & Main Developer",           "github.com/SaurabhKaperwan"),
        ...
        content.addView(TextView(context).apply {
            text = "CineStream developer and contributors ❤️"
        ...
        card.addView(LinearLayout(context).apply {
            ...
            addView(TextView(context).apply {
                text = "👨‍💻  Developers & Credits"; textSize = 12f
                setTypeface(null, android.graphics.Typeface.BOLD)
                setTextColor(theme.TEXT_SECONDARY); letterSpacing = 0.08f
                layoutParams = LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1f)
            })
